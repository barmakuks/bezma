...
public class Position implements Cloneable
{
	...
	/**
	 * Индекс бара. С него начинает ся поиск хода. Ход совершается от большего индекса к меньшему
	 */
	 ...
	 * 
	 * @details 1-24 - позиции фишек( >0 - белые, <0 - черные, 0 - пусто), 0 - бар белых, 25 - бар черных, 26,27 -
	 *          выброс черных и белых соответсвенно направление движения для белых прямое, для черных - обратное
	 * */

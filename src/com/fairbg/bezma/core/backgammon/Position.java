...
public class Position implements Cloneable
{
	...
	None,
	/**
	 * Board for white player (player in the bottom place), movements
	 * counter clockwise
	 */
	WhiteCCW,
    ...
    /**
     * Cube is proposed to the black player and placed into the right part of
     * the board
     */
    public static final int CUBE_RIGHT = 3;
    /**
     * Cube is proposed to the white player and placed into the left part of the
     * board
     */
	...
	{
	    return direction == PlayerColors.BLACK ? position : BAR_POSITION
		    - position;
	}
    }
	...
	{
	    BezmaLog.e("SET CHECKERS",
		    "Invalide size of incomming checkers array");
	...
	final int OPP_BAR_POSITION = getIndex(Position.BAR_POSITION,
		PlayerColors.getAltColor(player));
	...
	return color == 0 ? PlayerColors.NONE : color > 0 ? PlayerColors.WHITE
		: PlayerColors.BLACK;
    }
	...
	for (int i = 0; equals && i <= 25; i++)
	{
	    ...
	    PlayerColors other_color = other.getCheckerColor(i,
		    PlayerColors.BLACK);

	    equals = equals
		    && (other_color == color
			    || other_color == PlayerColors.NONE || color == PlayerColors.NONE);

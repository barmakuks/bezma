...
//            }
    ...
    private class PlayView extends View
    {
        ...
        protected void onDraw(Canvas canvas)
        {
            ...
            // Game conditions
            DrawingUtils.drawText(canvas, Integer.toString(m_MatchParameters.MatchLength), 240, 98, 48, 0, 0xFF302f2f, "fonts/OpiumB.TTF");
            // Players scores
            DrawingUtils.drawText(canvas, "0", 140, 98, 48, 0, 0xFFA30101, "fonts/OpiumB.TTF");

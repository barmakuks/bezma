...
public class MatchParametersActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        rbxFixedGames.setChecked(params.MatchType == MatchWinConditions.FixedGames);
    ...
    protected void returnData()
    {
        try
        {
            ...
            if (params.UseTimer)
            {
                params.MatchLimit = Integer.parseInt(edtMatchLimit.getText().toString());
                params.MoveLimit = Integer.parseInt(edtMoveLimit.getText().toString());
            }

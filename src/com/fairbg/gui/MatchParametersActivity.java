...
public class MatchParametersActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.match_parameters);
		...
		rbxFixedGames
				.setChecked(params.MatchType == MatchParameters.FIXED_GAMES);
		...
		rbxComputerRolls.setChecked(params.RollType == MatchParameters.COMPUTER_ROLLS);
		rbxPlayersRools.setChecked(params.RollType == MatchParameters.MANUAL_ROLLS);
	...
	protected void returnData() {
		try {
			...
			if (rbxFixedGames.isChecked()) {
				params.MatchType = MatchParameters.FIXED_GAMES;
				params.MatchLength = Integer.parseInt(edtFixedGames.getText().toString());
			} else {
				params.MatchType = MatchParameters.FIXED_POINTS;
			...
			if (rbxComputerRolls.isChecked()) {
				params.RollType = MatchParameters.COMPUTER_ROLLS;
			} else {
				params.RollType = MatchParameters.MANUAL_ROLLS;
